# -----------------------------------------------------------------------------
# This file is adapted from the Randomly-Pivoted-Cholesky project:
...
#    with few entry evaluations,” Commun. Pure Appl. Math., vol. 78, pp. 995–1041, 2025.
#
#   E. N. Epperly, J. A. Tropp & R. J. Webber,
#   “Embrace rejection: Kernel matrix approximation by accelerated
#    randomly pivoted Cholesky,” arXiv:2410.03969, 2024.
#
# License:
#   MIT License (c) 2022 Ethan Epperly
#   See https://github.com/eepperly/Randomly-Pivoted-Cholesky/blob/main/LICENSE
# -----------------------------------------------------------------------------
